...
@section('content')
    <div class="container py-16 hadiah-container">
        <div class="d-flex justify-content-between mb-lg-16 mb-sm-10 ">
            ...
            <span>
                <img src="{{ URL::asset('assets/img/sarjana-logo.png') }}" alt=""
                    class="img-fluid mb-5 ms-auto sarjana-logo-hadiah" width="220">
            </span>
        </div>
